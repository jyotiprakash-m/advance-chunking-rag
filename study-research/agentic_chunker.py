...
class AgenticChunker:
    ...
    def _find_relevant_chunk(self, proposition):
        ...
        # Use the new structured output method instead of deprecated extraction chain
        structured_llm = self.llm.with_structured_output(ChunkID, method="function_calling")
        extraction_result = structured_llm.invoke(chunk_found)
        chunk_found = extraction_result.chunk_id if extraction_result and hasattr(extraction_result, 'chunk_id') else None        # If you got a response that isn't the chunk id limit, chances are it's a bad response or it found nothing
        # So return nothing
